...
class PHP_CompatInfo_TestSuite_Cli extends PHPUnit_Framework_TestCase
{
    ...
    public function testRequest13147()
    {
        ...
        $exp = array('+-----------------------------+---------+------------+--------------------+',
                     ...
                     '+-----------------------------+---------+------------+--------------------+',
                     '| ...patInfo'.$ds.'tests'.$ds.'parseDir'.$ds.'* | 5.2.0   | gd         | ..._ERR_CANT_WRITE |',
                     '|                             |         | SQLite     | ...D_ERR_EXTENSION |',
                     '|                             |         | xdebug     | ...D_ERR_FORM_SIZE |',
                     '|                             |         |            | ...AD_ERR_INI_SIZE |',
                     '|                             |         |            | UPLOAD_ERR_NO_FILE |',
                     '|                             |         |            | ..._ERR_NO_TMP_DIR |',
                     '|                             |         |            | UPLOAD_ERR_OK      |',
    ...
    public function testReq13147ImproveRender()
    {
        ...
        $exp = array('+-----------------------------+---------+-------------+-----------------------+',
                     ...
                     '|                             |         | SQLite      | UPLOAD_ERR_EXTENSION  |',
                     '|                             |         | xdebug      | UPLOAD_ERR_FORM_SIZE  |',
                     '|                             |         |             | UPLOAD_ERR_INI_SIZE   |',
                     '|                             |         |             | UPLOAD_ERR_NO_FILE    |',
